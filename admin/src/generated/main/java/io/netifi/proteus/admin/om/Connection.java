...
public final class Connection extends com.google.protobuf.GeneratedMessageV3
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return io.netifi.proteus.admin.om.ProteusAdmin
        ...
        .ensureFieldAccessorsInitialized(
            io.netifi.proteus.admin.om.Connection.class,
            io.netifi.proteus.admin.om.Connection.Builder.class);
  }
  ...
  /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
  public io.netifi.proteus.admin.om.NoticeOrBuilder getNoticesOrBuilder(int index) {
    return notices_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < notices_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(4, notices_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    result = result && getNoticesList().equals(other.getNoticesList());
  ...
  public static io.netifi.proteus.admin.om.Connection parseFrom(java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
  ...
  public static io.netifi.proteus.admin.om.Connection parseFrom(com.google.protobuf.ByteString data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public io.netifi.proteus.admin.om.Connection buildPartial() {
      io.netifi.proteus.admin.om.Connection result =
          new io.netifi.proteus.admin.om.Connection(this);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
            io.netifi.proteus.admin.om.Notice, io.netifi.proteus.admin.om.Notice.Builder,
    ...
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public Builder setNotices(int index, io.netifi.proteus.admin.om.Notice value) {
      if (noticesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public Builder addNotices(int index, io.netifi.proteus.admin.om.Notice value) {
      if (noticesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public Builder addNotices(io.netifi.proteus.admin.om.Notice.Builder builderForValue) {
      if (noticesBuilder_ == null) {
        ensureNoticesIsMutable();
    ...
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public io.netifi.proteus.admin.om.Notice.Builder getNoticesBuilder(int index) {
    ...
    public io.netifi.proteus.admin.om.Notice.Builder addNoticesBuilder() {
      return getNoticesFieldBuilder()
          .addBuilder(io.netifi.proteus.admin.om.Notice.getDefaultInstance());
    }
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public io.netifi.proteus.admin.om.Notice.Builder addNoticesBuilder(int index) {
      return getNoticesFieldBuilder()
          .addBuilder(index, io.netifi.proteus.admin.om.Notice.getDefaultInstance());
    }
    /** <code>repeated .io.netifi.proteus.admin.om.Notice notices = 4;</code> */
    public java.util.List<io.netifi.proteus.admin.om.Notice.Builder> getNoticesBuilderList() {
