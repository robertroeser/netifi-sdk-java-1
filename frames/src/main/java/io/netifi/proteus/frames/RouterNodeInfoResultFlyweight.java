...
public class RouterNodeInfoResultFlyweight {
  ...
  public static int encode(
      ByteBuf byteBuf,
      RouterNodeInfoEventType eventType,
      String routerId,
  ...
  public static RouterNodeInfoEventType eventType(ByteBuf byteBuf) {
    byte aByte = byteBuf.getByte(0);
    return RouterNodeInfoEventType.from(aByte);
  }
